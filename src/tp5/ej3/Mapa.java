...
public class Mapa {
	...
	private Graph<String> getMapaCiudades() {
	...
	public void marcarRestringidos(List<String> lugaresRestringidos, boolean[] marcas) {
	...
	public int caminoMasCorto(Vertex<String> origen, Vertex<String> destino, List<String> caminoMinimo, List<String> caminoAct, boolean[] marcas, int total, int min) {
		marcas[origen.getPosition()] = true;
